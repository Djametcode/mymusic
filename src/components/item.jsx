...
const List = ({data}) => {
    ...
    return (
        <div className=" m-2 flex flex-col justify-center text-center gap-2 p-3 bg-white/30 rounded-3xl cursor-pointer snap-center">
...
const MusicList = () => {
    ...
    return(
        <div className=" flex overflow-auto p-3 snap-x snap-mandatory">
            {result}
        </div>
    )
}
